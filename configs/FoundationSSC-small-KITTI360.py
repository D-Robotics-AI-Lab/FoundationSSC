data_root = "datasets/SSCBench-KITTI-360/sscbench-kitti"
ann_file = "datasets/SSCBench-KITTI-360/sscbench-kitti/preprocess/labels"
...
model = dict(
    ...
    img_backbone=dict(
        ...
        ckpt_dir="ckpts/11-33-40/model_best_bp2.pth",
        cfg_path="ckpts/11-33-40/cfg.yaml",
    ),
    img_pre_neck=dict(
        type="SimpleFPN",
        backbone_channel=384,  # vits14
